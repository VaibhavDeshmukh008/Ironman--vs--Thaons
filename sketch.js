...
var ironmanImg,bgImg,thaonsImg;
var ball,rope;
...
bgImg=loadImage("GameBackground.jpg")
thaonsImg=loadImage("Thaons.png")
ironmanImg.scale=5;
}
...
function setup() {
  ...
  // create spriItes here
  ironman = new Ironman(200, 200, 80, 80);
  rope = new Rope(ironman.body, { x: 500, y: 50 });


thaons = new Thaons(1000,300,70,70);
}
